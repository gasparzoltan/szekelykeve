...
new Vue({
	...
	methods: {
		onShowDeleteDialog: function onShowDeleteDialog(articleId) {
			$('#dialog-' + articleId).slideToggle('fast');
		},
		onHideDeleteDialog: function onHideDeleteDialog(articleId) {
			$('#dialog-' + articleId).slideUp('fast');
		},
		onDeleteArticle: function onDeleteArticle(articleId, route) {
